...
class CategoryFeedCell: UICollectionViewCell {
    ...
    func configureContraints() {
        ...
        captionBlock.backgroundColor = UIColor.rgb(red: 230, green: 230, blue: 230)
        ...
        categoryBlock.backgroundColor = UIColor.rgb(red: 230, green: 230, blue: 230)
        ...
        priceBlock.backgroundColor = UIColor.rgb(red: 230, green: 230, blue: 230)

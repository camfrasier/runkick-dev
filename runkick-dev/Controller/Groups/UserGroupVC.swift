...
//  runkick-dev
//
//  Created by Cameron Frasier on 11/11/20.
...
class UserGroupVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
*/
    ...
    func configureViewComponents() {
        ...
        returnHomeButton.anchor(top: view.topAnchor, left: view.leftAnchor, bottom: nil, right: nil, paddingTop: 25, paddingLeft: 20, paddingBottom: 0, paddingRight: 0, width: 0, height: 0)
    }
    ...
    */
    // MARK: - UICollectionView
       ...
       func configureCollectionView() {
        ...
        let frame = CGRect(x: 0, y: 64, width: view.frame.width, height: view.frame.height - 0)
...
extension UserGroupVC: UISearchBarDelegate {
